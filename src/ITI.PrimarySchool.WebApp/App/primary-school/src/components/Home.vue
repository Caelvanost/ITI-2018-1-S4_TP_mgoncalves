<template>
    <section class="jumbotron text-center">
        <div class="container">
            ...
            <button type="button" @click="showAlert = true">Afficher l'alerte</button>
            ...
            <div>
                {{ counter }}
                <button type="button" @click="counter += 1">Increment</button>
...
export default {
    ...
    computed: {
        ...
        fruitsNotOrange() {
            return this.fruits.filter(x => x != 'orange');
        }
    }
}
</script>
